...
import { ensureFileSync, readJSONSync, readFile, outputJSON, outputFile, remove } from 'fs-extra';
...
class CacheManager {
    constructor({ cacheFolderPath, cacheKeyFormatter }) {
        ...
        const manifestData = readJSONSync(this.cacheManifestPath, { throws: false }) || {};
...
export { BufferFetcher, CacheManager, Format, Instrument, Price, Timeframe, URL_ROOT, defaultConfig, formatOutput, generateUrls, getHistoricRates, normaliseDates, processData, schema, validateConfig, validateConfigNode };
